//
//  NavigateDetailViewController.m
//  AdventureGuard
//
...
@interface NavigateDetailViewController ()
...
@implementation NavigateDetailViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROSingleDataLoader alloc] initWithDatasource:(NSObject<RODatasource> *)[[DatasourceManager sharedInstance] scamsDS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"NavigateDetail"];
...
- (void)loadDataSuccess:(ScamsDSSchemaItem *)item {
